...
{
    private function defaultFlowers()
    {
        return [
            [
    ...
    {
        $flowers = session('flowers', $this->defaultFlowers());
        return view('flowers.guest', compact('flowers'));
    }

    public function admin()
    {
        $flowers = session('flowers', $this->defaultFlowers());
        return view('flowers.admin', compact('flowers'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('flowers.admin');
    }
    ...
    public function edit($id)
    {
        ...
        $flower = $flowers[$id];
        return view('flowers.edit', compact('flower', 'id'));
    }
